      ...
      {sel && selId != null && (
        <div className="panel">
          ...
          <div className="actions">
            ...
            {sel.status === 1 && <p className="quiet"><CheckCircle size={15} weight="fill" /> Canonized after surviving attack. Most of the bond was returned; the displayed reserve stays funded for post-canonization challenges.</p>}
      ...
      {view === "about" && (
        <section className="about">
          ...
          <div className="steps">
            ...
            <div className="step"><span className="n">03</span><div><h3>Credence builds over rounds</h3><p>One pass is never the truth. Credence accumulates across rounds, with recent rounds weighing more. Validators agree exactly on every claim tier, quantized credence and attack-strength value that can control canonization, retraction or settlement.</p></div></div>
            ...
            <div className="step"><span className="n">05</span><div><h3>The funded challenge market</h3><p>Canonization returns 70% of the author bond and keeps 30% locked as a challenge reserve. Anyone can stake GEN to force a high-rigor re-trial. A successful post-canonization flip refunds the stake and pays a bounty from that reserve; a failed challenge forfeits its stake.</p></div></div>
          </div>

          <div className="grid2">
            <div className="panel" style={{ marginTop: 0 }}>
              <div className="sec-h" style={{ marginTop: 0 }}><Scales size={16} weight="bold" /><h2>Why on-chain &amp; non-deterministic</h2></div>
              <p className="quiet" style={{ display: "block", lineHeight: 1.6 }}>The judgment runs through <code>gl.nondet</code>: validators independently re-judge, then agree on exact normalized claim tiers, credence buckets and attack-strength buckets. The consequences &mdash; credence update, canonization, reserve and slashing &mdash; are computed deterministically on-chain.</p>
            </div>
            <div className="panel" style={{ marginTop: 0 }}>
